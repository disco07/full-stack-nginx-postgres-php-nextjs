...
const HeaderStyledSearch = (): JSX.Element => {
    ...
    <HeaderStyled>
      <HeaderWrap>
        <Header>
          ...
          <SmallScreenMax>
            <IoIosMenu size="1.7em" />
          </SmallScreenMax>
          <SmallScreenMin>
            <IoIosSearch size="1.7em" />
          </SmallScreenMin>
          <SmallScreen>
            <div className="logo">
              <Link href="/">
              ...
              <LargeScreen>
                <div className="navbar">
                  <Button color="blueNight">
                    <Link href="#">
                      <a>Voues êtes professionel ?</a>
                    </Link>
                  </Button>
                  <Button color="blueNightPartAudit">
...
export default HeaderStyledSearch;
